...
# Pieza · Seguridad, datos y límites
...
1. Resuelve el estado objetivo: usa la ruta indicada por la persona; si no la hay, lee
   ...
   adopta por ser el único que aparece. Localiza `guardrails` en su ruta y explica la `regla` y
...
Qué no debe pasar nunca, y qué lo impide de verdad.
...
Pregunta principal: **¿Qué no debe pasar nunca, y qué lo impide de verdad?**

En el ejemplo del ayudante de correo: No puede enviar correos. Solo lee la carpeta del proyecto. Los datos personales no salen de ahí. Y el texto que llega en un correo se trata como información, nunca como órdenes.

## Puntos clave

- Hay **dos puertas**: lo que te escribe quien habla contigo, y el texto de terceros que acaba dentro del trabajo.
...
1. Listar qué datos toca y cuáles no pueden salir de su sitio.
2. Dar a cada integración su identidad y su permiso mínimo.
3. Tratar todo texto de terceros como información.
4. Escribir qué acciones exigen confirmación.
5. Estimar el daño máximo y ajustar el encierro.
6. Definir retención y borrado.
...
`<directorio-del-estado>/piezas/guardrails.md` e incluye al final un bloque cercado
