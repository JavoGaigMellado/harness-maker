...
# Pieza · Flujos, delegación y supervisión
...
1. Resuelve el estado objetivo: usa la ruta indicada por la persona; si no la hay, lee
   ...
   adopta por ser el único que aparece. Localiza `flujo` en su ruta y explica la `regla` y
...
Cómo se organiza el trabajo y dónde decides tú.
...
Pregunta principal: **¿Cómo se organiza el trabajo y dónde decides tú?**

En el ejemplo del ayudante de correo: Para el correo habitual hay una secuencia: lee el hilo, mira la ficha, propone tres enfoques, tú eliges, redacta y guarda. Si no lo resuelve en tres intentos, te pregunta.
...
1. Listar las tareas habituales y cuáles merecen secuencia preparada.
2. Escribir los pasos y el criterio de parada de cada una.
3. Fijar topes de intentos, tiempo y coste.
4. Marcar dónde hace falta visto bueno.
5. Definir cuándo y a quién se escala.
6. Anotar qué decide el modelo y qué la persona.
...
`<directorio-del-estado>/piezas/flujo.md` e incluye al final un bloque cercado
