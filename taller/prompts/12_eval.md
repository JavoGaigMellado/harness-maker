...
# Pieza · Casos y criterios de éxito
...
1. Resuelve el estado objetivo: usa la ruta indicada por la persona; si no la hay, lee
   ...
   adopta por ser el único que aparece. Localiza `eval` en su ruta y explica la `regla` y
...
Qué cuenta como bien hecho, con ejemplos delante.
...
Pregunta principal: **¿Qué cuenta como bien hecho, y con qué ejemplos lo demuestras?**

En el ejemplo del ayudante de correo: Guardas seis correos reales con la respuesta que diste tú, dos casos que siempre salen mal (quejas y temas legales) y una checklist de cuatro puntos antes de enviar.
...
- El criterio de éxito **puede y debe escribirse antes** de dar autonomía.
...
1. Reunir de seis a diez encargos reales.
2. Guardar el resultado que consideras bueno.
3. Añadir casos límite y usos indebidos.
4. Escribir la checklist de aceptación.
5. Guardar lo corregido y qué se corrigió.
6. Revisar el banco con casos nuevos.
...
`<directorio-del-estado>/piezas/eval.md` e incluye al final un bloque cercado
