...
1. Resuelve el estado objetivo: usa la ruta indicada por la persona; si no la hay, lee
   ...
   adopta por ser el único que aparece. Localiza `medidor` en su ruta y explica la `regla` y
...
Si has delegado la comprobación en un mecanismo, ese mecanismo también puede estar mal.
...
Pregunta principal: **Si has delegado la comprobación, ¿quién comprueba al comprobador?**

En el ejemplo del ayudante de correo: Has puesto un comprobador que revisa los borradores. Antes de fiarte, le pasas diez correos que ya sabes cómo deberían salir: cinco bien y cinco mal. Y miras si acierta.
...
1. Reunir casos que deben aprobar y casos que deben fallar.
2. Comprobar el revisor contra ellos antes de fiarte.
3. Separar quien genera de quien evalúa.
4. Revisar los desacuerdos con la persona.
5. Declarar qué cubre y qué no.
...
`<directorio-del-estado>/piezas/medidor.md` e incluye al final un bloque cercado
