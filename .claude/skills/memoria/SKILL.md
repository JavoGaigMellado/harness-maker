---
name: memoria
description: Facilita la actividad Memoria y continuidad de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /memoria.
disable-model-invocation: true
---

<!-- GENERADO desde datos/anatomia.json por `harness-lab generate`. NO EDITAR A MANO. -->
# Actividad · Memoria y continuidad

1. Leer por completo `taller/prompts/02_memoria.md` y cumplir su doctrina, criterios y persistencia.
