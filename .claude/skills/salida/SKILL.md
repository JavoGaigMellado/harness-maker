---
name: salida
description: Facilita la actividad Resultados y artefactos de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /salida.
disable-model-invocation: true
---

<!-- GENERADO desde datos/anatomia.json por `harness-lab generate`. NO EDITAR A MANO. -->
# Actividad · Resultados y artefactos

1. Leer por completo `taller/prompts/08_salida.md` y cumplir su doctrina, criterios y persistencia.
