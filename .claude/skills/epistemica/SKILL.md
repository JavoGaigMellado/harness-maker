---
name: epistemica
description: Facilita la actividad Nada sin verificar de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /epistemica.
disable-model-invocation: true
---

<!-- GENERADO desde datos/anatomia.json por `harness-lab generate`. NO EDITAR A MANO. -->
# Actividad · Nada sin verificar

1. Leer por completo `taller/prompts/16_epistemica.md` y cumplir su doctrina, criterios y persistencia.
