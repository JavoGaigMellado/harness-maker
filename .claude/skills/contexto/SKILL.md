---
name: contexto
description: Facilita la actividad Contexto de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /contexto.
...
1. Leer por completo `taller/prompts/01_contexto.md` y cumplir su doctrina, criterios y persistencia.
...
## Aplicación concreta a Contexto
