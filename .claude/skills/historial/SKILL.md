---
name: historial
description: Facilita la actividad Historial, secretos y portabilidad de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /historial.
disable-model-invocation: true
---

<!-- GENERADO desde datos/anatomia.json por `harness-lab generate`. NO EDITAR A MANO. -->
# Actividad · Historial, secretos y portabilidad

1. Leer por completo `taller/prompts/17_historial.md` y cumplir su doctrina, criterios y persistencia.
