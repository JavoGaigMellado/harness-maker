---
name: validar
description: Facilita la actividad Coste de comprobar de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /validar.
disable-model-invocation: true
---

<!-- GENERADO desde datos/anatomia.json por `harness-lab generate`. NO EDITAR A MANO. -->
# Actividad · Coste de comprobar

1. Leer por completo `taller/prompts/10_validar.md` y cumplir su doctrina, criterios y persistencia.
