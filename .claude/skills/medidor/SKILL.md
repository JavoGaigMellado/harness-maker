---
name: medidor
description: Facilita la actividad ¿Quién revisa al revisor? de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /medidor.
disable-model-invocation: true
---

<!-- GENERADO desde datos/anatomia.json por `harness-lab generate`. NO EDITAR A MANO. -->
# Actividad · ¿Quién revisa al revisor?

1. Leer por completo `taller/prompts/11_medidor.md` y cumplir su doctrina, criterios y persistencia.
