---
name: eval
description: Facilita la actividad Casos y criterios de éxito de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /eval.
disable-model-invocation: true
---

<!-- GENERADO desde datos/anatomia.json por `harness-lab generate`. NO EDITAR A MANO. -->
# Actividad · Casos y criterios de éxito

1. Leer por completo `taller/prompts/12_eval.md` y cumplir su doctrina, criterios y persistencia.
