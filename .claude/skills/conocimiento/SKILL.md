---
name: conocimiento
description: Facilita la actividad Conocimiento y fuentes de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /conocimiento.
disable-model-invocation: true
---

<!-- GENERADO desde datos/anatomia.json por `harness-lab generate`. NO EDITAR A MANO. -->
# Actividad · Conocimiento y fuentes

1. Leer por completo `taller/prompts/04_conocimiento.md` y cumplir su doctrina, criterios y persistencia.
