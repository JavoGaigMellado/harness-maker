---
name: fallos
description: Facilita la actividad Fallos conocidos e incidentes de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /fallos.
disable-model-invocation: true
---

<!-- GENERADO desde datos/anatomia.json por `harness-lab generate`. NO EDITAR A MANO. -->
# Actividad · Fallos conocidos e incidentes

1. Leer por completo `taller/prompts/15_fallos.md` y cumplir su doctrina, criterios y persistencia.
