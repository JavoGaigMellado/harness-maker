---
name: prompts
description: Facilita la actividad Instrucciones persistentes de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /prompts.
disable-model-invocation: true
---

<!-- GENERADO desde datos/anatomia.json por `harness-lab generate`. NO EDITAR A MANO. -->
# Actividad · Instrucciones persistentes

1. Leer por completo `taller/prompts/03_prompts.md` y cumplir su doctrina, criterios y persistencia.
