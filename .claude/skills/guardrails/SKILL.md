---
name: guardrails
description: Facilita la actividad Seguridad, datos y límites de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /guardrails.
disable-model-invocation: true
---

<!-- GENERADO desde datos/anatomia.json por `harness-lab generate`. NO EDITAR A MANO. -->
# Actividad · Seguridad, datos y límites

1. Leer por completo `taller/prompts/05_guardrails.md` y cumplir su doctrina, criterios y persistencia.
