---
name: tools
description: Facilita la actividad Herramientas e integraciones de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /tools.
disable-model-invocation: true
---

<!-- GENERADO desde datos/anatomia.json por `harness-lab generate`. NO EDITAR A MANO. -->
# Actividad · Herramientas e integraciones

1. Leer por completo `taller/prompts/07_tools.md` y cumplir su doctrina, criterios y persistencia.
