---
name: flujo
description: Facilita la actividad Flujos, delegación y supervisión de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /flujo.
disable-model-invocation: true
---

<!-- GENERADO desde datos/anatomia.json por `harness-lab generate`. NO EDITAR A MANO. -->
# Actividad · Flujos, delegación y supervisión

1. Leer por completo `taller/prompts/09_flujo.md` y cumplir su doctrina, criterios y persistencia.
