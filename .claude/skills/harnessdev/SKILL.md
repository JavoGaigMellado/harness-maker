---
name: harnessdev
description: Facilita la actividad Configuración, automatización y permisos de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /harnessdev.
disable-model-invocation: true
---

<!-- GENERADO desde datos/anatomia.json por `harness-lab generate`. NO EDITAR A MANO. -->
# Actividad · Configuración, automatización y permisos

1. Leer por completo `taller/prompts/14_harnessdev.md` y cumplir su doctrina, criterios y persistencia.
