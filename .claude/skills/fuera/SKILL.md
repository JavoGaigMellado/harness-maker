---
name: fuera
description: Facilita la actividad Alcance y ciclo de vida de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /fuera.
disable-model-invocation: true
---

<!-- GENERADO desde datos/anatomia.json por `harness-lab generate`. NO EDITAR A MANO. -->
# Actividad · Alcance y ciclo de vida

1. Leer por completo `taller/prompts/18_fuera.md` y cumplir su doctrina, criterios y persistencia.
