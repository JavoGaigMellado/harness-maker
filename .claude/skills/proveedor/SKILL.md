---
name: proveedor
description: Facilita la actividad Plataforma y modelo de Harness-Maker, resume su estado, recoge decisiones y actualiza el mapa. Invocar manualmente con /proveedor.
disable-model-invocation: true
---

<!-- GENERADO desde datos/anatomia.json por `harness-lab generate`. NO EDITAR A MANO. -->
# Actividad · Plataforma y modelo

1. Leer por completo `taller/prompts/06_proveedor.md` y cumplir su doctrina, criterios y persistencia.
...
## Aplicación concreta a Plataforma y modelo
